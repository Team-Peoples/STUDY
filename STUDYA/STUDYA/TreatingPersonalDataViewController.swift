...
class TreatingPersonalDataViewController: UIViewController {
    ...
    fileprivate let titleLabel = CustomLabel(title: "개인정보처리방침", tintColor: .titleGeneral, size: 16, isBold: true, isNecessaryTitle: false)
    fileprivate let descriptionView: UITextView = {
       
        let view = UITextView(frame: .zero)
        view.isScrollEnabled = false
        view.font = UIFont.systemFont(ofSize: 14)
        view.textColor = UIColor.appColor(.titleGeneral)
