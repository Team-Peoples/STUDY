...
#define kServiceAppUrlScheme    @"com.sm3609824475.studymanagerapplication01"

#define kConsumerKey            @"TafpcVX1tY9l2WXpW33M"
#define kConsumerSecret         @"D10krBe0nX"
#define kServiceAppName         @"피플즈"
